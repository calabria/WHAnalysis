...
process.TauHistosBeforeDeltaR.tauSrc = cms.untracked.InputTag("producesUserDefinedVarsTau")

process.selectedTausPt1.cut = cms.string('pt > 25.0 && userInt("triggerMatchingLeg2") > 0.5 ')

process.selectedTausIso2.cut = cms.string('tauID("byMediumCombinedIsolationDeltaBetaCorr") < 0.5 && userInt("triggerMatchingLeg2") < 0.5 ')

#process.selectedTausMuonVeto2.src = cms.untracked.InputTag("produceWeightsLep2:patTausWithWeightsTight")
#process.TauHistosBeforeMuonVeto2.tauSrc = cms.untracked.InputTag("produceWeightsLep2:patTausWithWeightsTight")

process.selectedCompCandCharge = cms.EDFilter("CompCandChargeFilter",
       			CompCandSrc = cms.untracked.InputTag("ztautauVeto"),
			applyCharge1 = cms.untracked.bool(False),
			applyCharge2 = cms.untracked.bool(True),
        		filter = cms.bool(True)
			)

process.CompCandHistosAfterSel.isFR = cms.untracked.bool(True)
