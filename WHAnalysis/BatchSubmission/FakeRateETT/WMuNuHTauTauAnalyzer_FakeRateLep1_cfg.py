...
process.selectedTausIso.cut = cms.string('tauID("byTightCombinedIsolationDeltaBetaCorr") < 0.5 && userInt("triggerMatchingLeg2") < 0.5 ')

#process.selectedTausMuonVeto.src = cms.untracked.InputTag("produceWeightsLep1:patTausWithWeightsTight")
#process.TauHistosBeforeMuonVeto.tauSrc = cms.untracked.InputTag("produceWeightsLep1:patTausWithWeightsTight")

process.selectedTausPt2.cut = cms.string('pt > 20.0 && userInt("triggerMatchingLeg2") > 0.5 ')
