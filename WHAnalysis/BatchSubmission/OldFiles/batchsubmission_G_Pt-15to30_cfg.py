...
process.GamamJet_15to30  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-15to30.txt"),

 )

process.p = cms.Path(process.GamamJet_15to30)
