...
process.GammaJet_1800  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-1800.txt"),

 )

process.p = cms.Path(process.GammaJet_1800)
