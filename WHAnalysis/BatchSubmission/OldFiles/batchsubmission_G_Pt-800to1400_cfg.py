...
process.GammaJet_800to1400  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-800to1400.txt"),

 )

process.p = cms.Path(process.GammaJet_800to1400)
