...
process.QCD20_30_EM  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("./TXTFiles/QCD20_30_EM.txt"),
...
process.QCD20_30_EM_eet  = cms.EDAnalyzer('BatchSubmission',
	...
	sample = cms.untracked.string("QCD20_30_EM_eet"),
	pathCFG = cms.untracked.string("/cmshome/calabria/Code_42X_TauIDNov/CMSSW_4_2_8_patch7/src/"),
	savingPath = cms.untracked.string("/lustre/cms/store/user/calabria/Data/Analisi/"),
...
process.QCD20_30_EM_mmt  = cms.EDAnalyzer('BatchSubmission',

	fileCFG = cms.untracked.string("WMuNuHTauTauAnalyzer_mmt_cfg.py"),
	fileCSH = cms.untracked.string("batchJob_cmssusy.csh"),

	sample = cms.untracked.string("QCD20_30_EM_mmt"),
	pathCFG = cms.untracked.string("/cmshome/calabria/Code_42X_TauIDNov/CMSSW_4_2_8_patch7/src/"),
	savingPath = cms.untracked.string("/lustre/cms/store/user/calabria/Data/Analisi/"),
	txtFile = cms.untracked.string("./TXTFiles/QCD20_30_EM_mmt.txt"),

)

process.p = cms.Path(process.QCD20_30_EM + process.QCD20_30_EM_eet + process.QCD20_30_EM_mmt)
