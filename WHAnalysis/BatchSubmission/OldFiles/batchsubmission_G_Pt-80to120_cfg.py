...
process.GammaJet_80to120 = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-80to120.txt"),

 )

process.p = cms.Path(process.GammaJet_80to120)
