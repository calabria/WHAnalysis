...
process.GammaJet_30to50  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-30to50.txt"),

 )

process.p = cms.Path(process.GammaJet_30to50)
