...
process.GammaJet_0to15  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-0to15.txt"),

 )

process.p = cms.Path(process.GammaJet_0to15)
