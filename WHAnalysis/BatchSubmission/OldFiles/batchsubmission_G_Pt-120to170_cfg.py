...
process.GammaJet_120to170  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-120to170.txt"),

 )

process.p = cms.Path(process.GammaJet_120to170)
