...
process.GammaJet_470to800  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-470to800.txt"),

 )

process.p = cms.Path(process.GammaJet_470to800)
