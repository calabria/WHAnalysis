...
process.GammaJet_50to80  = cms.EDAnalyzer('BatchSubmission',
	...
	txtFile = cms.untracked.string("G_Pt-50to80.txt"),

 )

process.p = cms.Path(process.GammaJet_50to80)
