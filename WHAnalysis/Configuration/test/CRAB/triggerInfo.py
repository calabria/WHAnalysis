...
defaultPDs = ['HT', 'METBTag', 'Jet', 'MultiJet', 'SingleMu', 'DoubleMu', 'MuOnia', 'MuEG', 'MuHad', 'SingleElectron', 'DoubleElectron', 'Photon', 'ElectronHad', 'PhotonHad', 'Tau', 'TauPlusX', 'Commissioning', 'Cosmics', 'MinBias']
